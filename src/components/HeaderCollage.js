    ...
    render() {
        ...
        return (
            <div className="c-header__background -home">
                <img className="home-layer-four" src={home4} alt="Home Collage Layer 4" />
                <img className="home-layer-three" src={home3} alt="Home Collage Layer 3" />
                <img className="home-layer-two" src={home2} alt="Home Collage Layer 2" />
                <img className="home-layer-one" src={home1} alt="Home Collage Layer 1" />
            </div>
        );
    }
}
